...
public class Product : EntityBase
{
    ...
    {
        get => price;
        set => SetProptery(ref price, value);
    }
    public decimal Cost
    {
        get => cost;
        set => SetProptery(ref cost, value);
    }
    public bool IsActive
    {
        get => isActive;
        set => SetProptery(ref isActive, value);
    }
    ...
    {
        get => category;
        set => SetProptery(ref category, value);
    }
